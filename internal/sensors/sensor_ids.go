...
var defaultMonitoredSensors = []MonitoredSensor{
	...
	{ID: 6, Publish: true},   // BrakeDepth
	{ID: 7, Publish: true},   // AcceleratorDepth
	...
	{ID: 21, Publish: true}, // DriverSeatbelt
	...
	{ID: 27, Publish: true}, // DriverACTemperature
	{ID: 28, Publish: true}, // TemperatureUnit
	{ID: 29, Publish: true}, // BatteryCapacity
	{ID: 30, Publish: true}, // SteeringAngle
	{ID: 31, Publish: true}, // SteeringRotationSpeed
	...
	{ID: 36, Publish: true}, // LaneCurvature
	{ID: 37, Publish: true}, // RightLineDistance
	{ID: 38, Publish: true}, // LeftLineDistance
	{ID: 39, Publish: true}, // BatteryVoltage12V
	{ID: 40, Publish: true}, // RadarFrontLeft
	{ID: 41, Publish: true}, // RadarFrontRight
	{ID: 42, Publish: true}, // RadarRearLeft
	{ID: 43, Publish: true}, // RadarRearRight

	// 45‑56 --------------------------------------------------- 
	{ID: 44, Publish: true}, // RadarLeft
	{ID: 45, Publish: true}, // RadarFrontMidLeft
	{ID: 46, Publish: true}, // RadarFrontMidRight
	{ID: 47, Publish: true}, // RadarRearCenter
	{ID: 48, Publish: true}, // FrontWiperSpeed
	{ID: 49, Publish: true}, // WiperGear
	{ID: 50, Publish: true}, // CruiseSwitch
	{ID: 51, Publish: true}, // DistanceToCarAhead
	...
	// 57‑66 ---------------------------------------------------
	{ID: 57, Publish: true}, // LeftTurnSignal
	{ID: 58, Publish: true}, // RightTurnSignal
	{ID: 59, Publish: true}, // DriverDoorLock
	// ID 60 is undocumented in the spec – it never appears in the XML.

	{ID: 61, Publish: true}, // DriverWindowOpenPercent
	{ID: 62, Publish: true}, // PassengerWindowOpenPercent
	{ID: 63, Publish: true}, // LeftRearWindowOpenPercent
	{ID: 64, Publish: true}, // RightRearWindowOpenPercent
	{ID: 65, Publish: true}, // SunroofOpenPercent
	{ID: 66, Publish: true}, // SunshadeOpenPercent

	// 67‑72 ---------------------------------------------------
	{ID: 67, Publish: true}, // VehicleOperatingMode
	{ID: 68, Publish: true}, // VehicleRunningMode
	...
	// 73‑84 ---------------------------------------------------
	{ID: 73, Publish: true}, // PassengerSeatbeltWarn
	{ID: 74, Publish: true}, // Row2LeftSeatbelt
	{ID: 75, Publish: true}, // Row2RightSeatbelt
	{ID: 76, Publish: true}, // Row2CenterSeatbelt
	...
	{ID: 81, Publish: true}, // DriverDoor
	{ID: 82, Publish: true}, // PassengerDoor
	{ID: 83, Publish: true}, // LeftRearDoor
	{ID: 84, Publish: true}, // RightRearDoor

	// 85‑107 --------------------------------------------------
	{ID: 85, Publish: true}, // Hood
	{ID: 86, Publish: true}, // TrunkDoor
	{ID: 87, Publish: true}, // FuelTankCap
	{ID: 88, Publish: true}, // AutoParking
	{ID: 89, Publish: true}, // ACCCruiseStatus
	{ID: 90, Publish: true}, // RearLeftProximityAlert
	{ID: 91, Publish: true}, // RearRightProximityAlert
	{ID: 92, Publish: true}, // LaneKeepAssistStatus
	{ID: 93, Publish: true}, // LeftRearDoorLock
	{ID: 94, Publish: true}, // PassengerDoorLock
	{ID: 95, Publish: true}, // RightRearDoorLock
	{ID: 96, Publish: true}, // TrunkLock
	{ID: 97, Publish: true}, // LeftRearChildLock
	{ID: 98, Publish: true}, // RightRearChildLock
	{ID: 99, Publish: true}, // LowBeamLights
	{ID: 100, Publish: true}, // LowBeamLights (Secondary)
	{ID: 101, Publish: true}, // HighBeamLights
	// IDs 102 and 103 are undocumented – they never appear in the XML.

	{ID: 104, Publish: true}, // FrontFogLights
	{ID: 105, Publish: true}, // RearFogLights
	{ID: 106, Publish: true}, // FootwellLights
	{ID: 107, Publish: true}, // DaytimeRunningLights
	{ID: 108, Publish: true}, // EngineWaterTemperature
	{ID: 109, Publish: true}, // HazardLights

	// 1001‑2007 -----------------------------------------------
	{ID: 1001, Publish: true}, // SurroundViewStatus
	{ID: 1002, Publish: true}, // UIConfigVersion
	{ID: 1003, Publish: true}, // SentryModeStatus
	{ID: 1004, Publish: true}, // PowerOffRecordingConfig
	{ID: 1006, Publish: true}, // PowerOffSentryAlarm
	{ID: 1007, Publish: true}, // WiFiStatus
	{ID: 1008, Publish: true}, // BluetoothStatus
	{ID: 1009, Publish: true}, // BluetoothSignalStrength

	{ID: 1101, Publish: true}, // WirelessADBSwitch
